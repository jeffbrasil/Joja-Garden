        ...
        <form className="space-y-6" onSubmit={handleLogin}>
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="cpf" className="text-xs font-bold text-[#253528]/70 uppercase tracking-wide ml-1">
                CPF
              </Label>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="password" className="text-xs font-bold text-[#253528]/70 uppercase tracking-wide ml-1">
                  Senha
                </Label>
              </div>
              <div className="relative group">
                <Lock className={`absolute left-4 top-3.5 h-5 w-5 transition-colors ${errorMessage ? "text-red-400" : "text-[#8BA889] group-focus-within:text-[#49654E]"}`} />
                <Input
                  id="password"
              ...
              <div className="flex justify-end pt-1">
                 <button
                    ...
                    className="text-xs font-semibold text-[#49654E] hover:text-[#253528] hover:underline transition-all"
                  >
                    Esqueceu a senha?
                  </button>
              </div>
          ...
          {errorMessage && (
            <div className="animate-in slide-in-from-top-2 fade-in duration-300 rounded-xl bg-red-50 border border-red-100 p-4 flex items-start gap-3">
                ...
                <div className="flex flex-col">
                    <h4 className="text-sm font-bold text-red-800">Falha no acesso</h4>
          ...
          >
            {isLoading ? (
              ...
              errorMessage ? "Tentar Novamente" : "Acessar Sistema"
            )}
          </Button>
